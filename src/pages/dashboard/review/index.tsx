                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`rounded-md px-2 py-1 text-xs font-semibold text-gray-800 ${
                          getRatingColor(review.ratings?.averageRating || 0)
                        }`}
                      >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white w-full max-w-xl rounded-lg shadow-lg p-6 relative">
            ...
            <p className="text-sm mb-2">
              ...
              {selectedReview.transactionType}
            </p>

            <p className="text-sm mb-2">
              <strong>Transaction Date:</strong>{" "}
              {formatDate(selectedReview.transactionDate)}
            </p>
            ...
            {selectedReview.ratings && (
              <div className="mb-3">
                ...
                <ul className="ml-4 text-sm">
                  ...
                  <li>
                    Value for Money: {selectedReview.ratings.valueForMoney}
                  </li>
                  <li>
                    Location Accuracy:{" "}
                    {selectedReview.ratings.locationAccuracy}
                  </li>
                  <li>
                    Hidden Fees:{" "}
                    {selectedReview.ratings.disclosedHiddenFees}
                  </li>
                  <li>
                    Average Rating:{" "}
                    {selectedReview.ratings.averageRating}
                  </li>
                </ul>
              </div>
            )}
