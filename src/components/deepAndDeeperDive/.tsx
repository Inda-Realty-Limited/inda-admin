  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        {/* Page Title */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Deeper Dive Report - Admin Input</h1>
          <p className="text-gray-600 text-sm">Enter and manage property due diligence information</p>
        </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <input
                type="text"
                value="IND-2024-0847"
                className="w-full px-4 py-2.5 bg-gray-100 border border-gray-200 rounded text-sm text-gray-900"
                readOnly
              />
            </div>
            <div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Years Built</label>
              <input
                type="text"
                value="2019"
                className="w-full px-4 py-2.5 bg-gray-100 border border-gray-200 rounded text-sm text-gray-900"
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-3">
            {findings.map((finding) => (
              <div key={finding.id} className="flex items-center gap-4 bg-gray-50 p-4 rounded-lg">
                <select
                ...
                <span className="flex-1 text-sm text-gray-700">{finding.text}</span>
                <div className="flex items-center gap-2">
                  <button className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-teal-600 hover:bg-teal-50 rounded transition">
                    <Edit2 size={14} />
                    Edit
                  </button>
                  <button
                    onClick={() => deleteFinding(finding.id)}
                    className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-red-600 hover:bg-red-50 rounded transition"
                  >
                    <Trash2 size={14} />
                    Delete
                  </button>
          ...
          <button className="mt-4 w-full py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50 transition">
            Add Finding
          </button>
        </div>
      </main>
